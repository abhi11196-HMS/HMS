...
//delete employee using cell and userId
	...
	@Modifying
	@Query(value = "insert into users (id,first_name,last_name,email,password,cell_no,role,security_question,security_answer) values(:id,:firstName,:lastName,:email"
